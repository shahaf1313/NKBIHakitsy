...
class TestNorthStock(unittest.TestCase):
    def test_AddStockItemPrices(self):
        ...
        self.assertIs(isinstance(orbit.subItemDetails[("10", "green")].prices, Prices), True)
        self.assertEqual(orbit.subItemDetails[("10", "green")].prices.farEastPrice, 10)
        self.assertEqual(orbit.subItemDetails[("10", "green")].prices.exportPrice, 15)
        self.assertEqual(orbit.subItemDetails[("10", "green")].prices.wholesalePrice, 25)
        self.assertEqual(orbit.subItemDetails[("10", "green")].prices.retailPrice, 50)
        self.assertEqual(orbit.subItemDetails[("10", "green")].prices.currency, "dollar")
        print(NorthStockItem.__dict__)
